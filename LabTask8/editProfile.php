              ...
              if ($connection->connect_error) {
                  ...
                  $sql = "UPDATE users SET email='$email', image= '$target_file',
                    ...
                    if ($connection->query($sql) === TRUE) {
                      ...
                      header('Location:http://localhost/My project/project/logout.php');
                      exit();
                    }
              }
  }
    ...
    <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
		<script>
			function validation(){
				...
				if(email.value=="" ||  pass.value=="" ||  cpass.value=="" ||  phone.value=="" ||  address.value==""){
				                ...
				                <div class="form-group row ">
				                    ...
				                    <div class="col-md-9 mt-2">
				                        ...
				                        <input class="form-control" type="number" name="id" value="<?php echo $user["id"]; ?>" hidden />
																<input class="form-control" type="number" name="image" value="<?php echo $user["image"]; ?>" hidden />
				                    </div>
				                </div>
				        </div>
					</div>
